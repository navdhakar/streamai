...
class AutoMistral:
    ...
    def train(self, base_model:str="", dataset_url:str=None, model_name:str="mistralfinetuned", num_train_epochs:int=5, max_length:int=512, resume_checkpoint:str=None):
